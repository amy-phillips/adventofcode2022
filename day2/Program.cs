...
class RockPaperScissors {
    ...
    private static int GetMyScore(Choice myChoice) {
        switch(myChoice) {
            case Choice.ROCK:
            return 1;
            case Choice.PAPER:
    ...
    private static int GetResultScore(Choice myChoice, Choice theirChoice) {
        if(myChoice == theirChoice)
            return 3;
        switch(myChoice) {
            case Choice.ROCK:
                if(theirChoice == Choice.PAPER) return 0;
                return 6;
            case Choice.PAPER:
                if(theirChoice == Choice.SCISSORS) return 0;
                return 6;
            case Choice.SCISSORS:
                if(theirChoice == Choice.ROCK) return 0;
                return 6;
        }
